...
{ //bug introduced, reveals cards until 3 treasure cards instead of 2
...
{ //bug, draw two cards instead of 3
  int i;
...
{ //bug, no drawn card, and +3 actions
  //+1 Card
  //drawCard(currentPlayer, state);
  //removed for bug
...
{ //discards 2 cards instead of one
  //+1 buy
  state->numBuys++;
